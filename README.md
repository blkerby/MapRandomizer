...
```sh
mkdir maps && cd maps
wget https://storage.googleapis.com/super-metroid-map-rando/maps/session-2023-06-08T14:55:16.779895.pkl-small-51-subarea-balance-2.tgz
mv session-2023-06-08T14:55:16.779895.pkl-small-51-subarea-balance-2.tgz maps.tar.gz && tar xfz maps.tar.gz
cd ..
```
...
```sh
cd rust
cargo run --bin maprando-cli -- --map ../maps/session-2023-06-08T14:55:16.779895.pkl-small-51-subarea-balance-2/10005.json --item-placement-seed 1 --input-rom YOUR-PATH-TO-VANILLA-ROM --output-rom OUTPUT-ROM-FILENAME
```
