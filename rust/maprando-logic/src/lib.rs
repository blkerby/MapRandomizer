    ...
    pub fn collect(
        ...
        match item {
            Item::Missile => {
                ...
                let new_max_missiles = std::cmp::min(999, (ammo_collect_fraction
            ...
            Item::Super => {
                ...
                let new_max_supers = std::cmp::min(99, (ammo_collect_fraction
            ...
            Item::PowerBomb => {
                ...
                let new_max_power_bombs = std::cmp::min(99, (ammo_collect_fraction
            ...
            Item::ReserveTank => {
                ...
                self.inventory.max_reserves = std::cmp::min(400, self.inventory.collectible_reserve_tanks * 100);
                if !tech[game_data.manage_reserves_tech_idx] {
                    self.inventory.max_reserves =
                        Capacity::min(self.inventory.max_reserves, self.inventory.max_energy);
                }
