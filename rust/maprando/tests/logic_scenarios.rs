...
use maprando::{
    ...
    settings::{
        ...
        InitialMapRevealSettings, ItemProgressionSettings, MapStationActivationSettings, Objective,
...
fn get_settings(scenario: &Scenario) -> Result<RandomizerSettings> {
    ...
    Ok(RandomizerSettings {
        ...
        quality_of_life_settings: QualityOfLifeSettings {
            ...
            map_station_activation_settings: MapStationActivationSettings {
                preset: Some(maprando::settings::MapStationActivationPreset::Full),
                save_stations: maprando::settings::MapStationActivationLevel::Full,
                refill_stations: maprando::settings::MapStationActivationLevel::Full,
                ship: maprando::settings::MapStationActivationLevel::Full,
                objectives: maprando::settings::MapStationActivationLevel::Full,
                area_transitions: maprando::settings::MapStationActivationLevel::Full,
                items1: maprando::settings::MapStationActivationLevel::Full,
                items2: maprando::settings::MapStationActivationLevel::Full,
                ...
                sub_area: maprando::settings::MapStationActivationSubArea::Same,
            },
