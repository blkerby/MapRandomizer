...
async fn randomize(
    ...
    let seed_data = SeedData {
        ...
        fast_saves: settings.quality_of_life_settings.fast_saves,
        fast_baby_cutscene: settings.quality_of_life_settings.fast_baby_cutscene,
        fast_mother_brain_cutscene: settings.quality_of_life_settings.fast_mother_brain_cutscene,
        fast_decompression: settings.quality_of_life_settings.fast_decompression,
        camera_fixes: settings.quality_of_life_settings.camera_fixes,
        fix_blue_echoes: settings.quality_of_life_settings.fix_blue_echoes,
