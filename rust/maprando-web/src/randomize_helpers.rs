...
pub struct SeedHeaderTemplate<'a> {
    ...
    fast_saves: bool,
    fast_baby_cutscene: bool,
    fast_mother_brain_cutscene: bool,
    fast_decompression: bool,
    camera_fixes: bool,
    fix_blue_echoes: bool,
    respin: bool,
...
pub fn render_seed(
    ...
    let seed_header_template = SeedHeaderTemplate {
        ...
        etank_size: seed_data.settings.item_progression_settings.etank_size as i32,
        reserve_size: seed_data.settings.item_progression_settings.reserve_size as i32,
        ...
        fast_saves: seed_data.fast_saves,
        fast_baby_cutscene: seed_data.fast_baby_cutscene,
        fast_mother_brain_cutscene: seed_data.fast_mother_brain_cutscene,
        fast_decompression: seed_data.fast_decompression,
        camera_fixes: seed_data.camera_fixes,
        fix_blue_echoes: seed_data.fix_blue_echoes,
