...
struct RandomizeRequest {
    ...
    disable_etank_refill: Text<bool>,
...
fn render_seed(
    ...
    let seed_header_template = SeedHeaderTemplate {
        ...
        disable_etank_refill: seed_data.disable_etank_refill,
...
fn get_difficulty_tiers(
    ...
    for preset_data in presets.iter().rev() {
        ...
        let new_difficulty = DifficultyConfig {
            ...
            disable_etank_refill: difficulty.disable_etank_refill,
...
async fn randomize(
    ...
    let difficulty = DifficultyConfig {
        ...
        disable_etank_refill: req.disable_etank_refill.0,
