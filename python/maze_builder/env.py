...
class MazeBuilderEnv:
    ...
    def count_connectivity_violations(self, room_mask, room_position_x, room_position_y):
        ...
        start_component = output_components[:, self.start_part_id].to(torch.long)
        ...
        connectivity2.compute_connectivity2(
            ...
            self.part_room_id_cpu,
            num_parts,
            self.durable_directed_edges,  # Include reverse edges in rooms like Crocomire's Room
            output_components,
            output_adjacency,
            output_adjacency_unpacked,
        )
    ...
    def init_part_data(self):
        ...
        for room in self.rooms:
            ...
            # TODO: handle starting room in a less hacky way:
            if room.name == "Landing Site":
                self.start_part_id = num_parts
