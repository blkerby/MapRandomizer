...
logging.info(
    "map_x={}, map_y={}, num_envs={}, batch_size_pow1={}, pass_factor={}, lr0={}, lr1={}, replay_size={}/{}, num_params={}, decay_amount={}, temp0={}, temp1={}, eps0={}, eps1={}, betas={}".format(
        map_x, map_y, session.envs[0].num_envs, batch_size_pow1, pass_factor, lr0, lr1, session.replay_buffer.size,
...
for i in range(1000000):
    ...
    if session.num_rounds % print_freq < num_gen_rounds:
        ...
        logging.info(
            "{}: cost={:.3f} (min={:d}, frac={:.6f}), rooms={:.3f}, doors={:.3f} | loss={:.5f}, cost={:.3f} (min={:d}, frac={:.4f}), p={:.6f}, f={:.5f}".format(
