...
# session_eval = pickle.load(open('models/checkpoint-1-eval.pkl', 'rb'))
...
# pickle.dump(eval_batches, open('models/checkpoint-1-eval_batches.pkl', 'wb'))
# pickle.dump(eval_batches, open('models/eval_batches.pkl', 'wb'))
...
for i in range(1000000):
    ...
    if session.num_rounds % save_freq < num_gen_rounds:
        with util.DelayedKeyboardInterrupt():
            ...
            # pickle.dump(session, open('models/checkpoint-1-train.pkl', 'wb'))
