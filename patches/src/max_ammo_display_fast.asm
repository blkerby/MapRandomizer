; Based on https://raw.githubusercontent.com/theonlydude/RandomMetroidSolver/master/patches/common/src/max_ammo_display.asm
...
!bank_80_free_space_start = $80CDA0
!bank_80_free_space_end = $80D02F
